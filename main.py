...
def main(file_path,in_channels,out_channels,lr,wd,world_size,rank,local_rank,epochs,batch_size,mode,n_workers=2):
    ...
    if mode == 'train':
        ...
        model = model.to(device)
        predict(test_loader,model,device,top_k=5)
